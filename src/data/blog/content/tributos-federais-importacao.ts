export const content = `## Tributos Federais na Importação: II, IPI, PIS, COFINS — Guia Completo
...
> **Quer simular os tributos da sua próxima importação?** Acesse a [Calculadora de Importação](/landing/calculadora-importacao) da TRADEXA e obtenha em segundos o custo total da sua operação, incluindo II, IPI, PIS, COFINS e ICMS.
