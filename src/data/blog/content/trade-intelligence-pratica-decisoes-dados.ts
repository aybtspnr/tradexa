export const content = `## O Que é Trade Intelligence e Por Que Ela Importa Agora
...
1. Dois de seus principais concorrentes estavam importando componentes similares de um fornecedor na Coreia do Sul que a empresa não conhecia, com preços FOB cerca de 18% inferiores aos praticados por seus fornecedores italianos tradicionais.

2. Um terceiro concorrente havia reduzido drasticamente seus volumes de importação nos últimos seis meses, sinalizando possíveis dificuldades financeiras ou uma mudança estratégica que abria espaço para ganho de participação de mercado.

3. Havia uma tendência clara de migração de fornecedores — enquanto as importações totais do setor cresciam 7% ao ano, as importações de fornecedores chineses cresciam 23%, indicando uma mudança estrutural de sourcing que a empresa ainda não havia percebido.
