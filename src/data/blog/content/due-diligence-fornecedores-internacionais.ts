export const content = `## Introdução: Por Que a Due Diligence é a Etapa Mais Importante da Importação
...
**Reputacional (itens 9-16)**
9. Anos de operação comprovados
10. Presença em plataformas B2B (Alibaba, Global Sources, IndiaMART)
11. Avaliações e reclamações nessas plataformas
12. Histórico de exportação verificado via dados de comércio exterior (TRADEXA)
13. Referências de pelo menos 3 clientes contatadas e positivas
14. Busca no Google no idioma local por problemas/fraudes/processos
15. Consulta a câmaras de comércio bilaterais sobre reclamações
16. Presença em listas de fraude (Scamadviser, fóruns de importadores)

**Financeira (itens 17-21)**
17. Demonstrações financeiras ou relatório de crédito (se disponível)
18. Carta de referência bancária
19. Seguro de crédito à exportação (verificar se possui)
20. Condições de pagamento razoáveis (evitar 100% antecipado)
21. Tempo de relacionamento com o banco declarado

**Compliance e Sanções (itens 22-26)**
22. Screening em listas de sanções (ONU, OFAC, UE, UK)
23. Screening em listas de trabalho escravo (Lista Suja e equivalentes)
24. Verificação de PEPs na estrutura societária
25. Política anticorrupção documentada
26. Licenças ambientais e ausência de multas ambientais recentes

**Técnica e Operacional (itens 27-30)**
27. Visita técnica presencial ou auditoria de terceira parte (SGS, BV, Intertek)
28. Capacidade produtiva compatível com o volume do pedido
29. Controles de qualidade documentados e verificados
30. Amostras aprovadas e lacradas como referência contratual
