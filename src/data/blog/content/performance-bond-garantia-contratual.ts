export const content = `## O que é Performance Bond?
...
1. Negociar contratos com cláusulas de execução condicionais, sempre que possível.
2. Estabelecer limites máximos de exposição por cliente e por região.
3. Manter contragarantias diversificadas, não concentrando todo o risco em um único ativo.
4. Utilizar ferramentas de gestão de garantias, como as oferecidas pela TRADEXA, que monitoram prazos, valores e condições de cada bond em tempo real.
