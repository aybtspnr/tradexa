export const content = `## Introdução: Djibuti, a Porta de Entrada para o Chifre da África
...
O \
<h2>Continue Aprofundando seus Conhecimentos em Introdução: Djibuti, a Porta de Entrada para o Chifre da África</h2>
