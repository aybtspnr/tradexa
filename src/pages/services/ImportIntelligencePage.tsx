...
export default function ImportIntelligencePage() {
  return (
    <GenericServicePage
      ...
      features={[
        {"icon": "Database", "title": "Dados Completos", "desc": "Registros atualizados mensalmente com CNPJ, NCM, valor e origem."},
      ...
      seoTitle="Inteligência de Importação com Dados Brasileiros"
      seoParagraphs={[
        "O mercado de importação brasileiro movimenta bilhões de dólares anualmente. Com a TRADEXA, você acessa cada registro individual de importação — CNPJ do importador, produto (NCM), país de origem, valor FOB, frete, seguro e peso líquido. Todos os dados são verificáveis e atualizados mensalmente.",
