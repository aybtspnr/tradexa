...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/export-import-data", icon: BarChart3, label: "Export Import Data" },
      { to: "/company-global-profile", icon: Building2, label: "Perfil Global Empresa" },
      { to: "/radar-concorrencia", icon: Radar, label: "Radar de Concorrência" },
      { to: "/global-trade-comparison", icon: ArrowLeftRight, label: "Comparador Global" },
      { to: "/ncm-global-dashboard", icon: Globe, label: "NCM Global Dashboard" },
      { to: "/us-trade-intelligence", icon: Flag, label: "US Trade Intelligence" },
      { to: "/trade-network", icon: Share2, label: "Trade Network" },
      { to: "/trade-routes", icon: Map, label: "Trade Routes" },
      { to: "/period-comparison", icon: Calendar, label: "Period Comparison" },
      { to: "/ncm-explorer", icon: Search, label: "NCM Explorer" },
      { to: "/market-report", icon: FileText, label: "Market Report" },
      { to: "/new-players", icon: UserPlus, label: "New Players" },
    ],
  },
  {
    key: "logistics",
    ...
    items: [
      ...
      { to: "/port-activity", icon: Anchor, label: "Port Activity Global" },
      { to: "/track-trace", icon: Navigation, label: "Track & Trace" },
      { to: "/supply-chain", icon: Activity, label: "Supply Chain Map" },
    ],
  },
  {
    key: "account",
