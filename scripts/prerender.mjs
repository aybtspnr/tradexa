...
const BLOG_POSTS = [
  ...
  { slug: "dta-documento-transito-aduaneiro", name: "DTA: Documento de Trânsito Aduaneiro", desc: "Entenda o DTA, quando é necessário, como emitir e as modalidades de trânsito aduaneiro. Documentacao, prazos e procedimentos para liberacao de cargas na..." },
  ...
  { slug: "construcao-civil-importacao-acabamentos", name: "Construção Civil: Importação de Materiais e Acabamentos", desc: "Saiba como importar pisos, revestimentos, louças, metais sanitários e materiais de acabamento para construção civil — classificação fiscal e fornecedores." },
  ...
  { slug: "crescimento-ecommerce-cross-border-brasil", name: "Crescimento E-commerce Cross-Border", desc: "Análise do crescimento do e-commerce cross-border no Brasil — plataformas, Remessa Conforme, tendências de consumo e oportunidades para importadores." },
  ...
  { slug: "corredores-ferroviarios-logistica", name: "Corredores Ferroviários no Brasil: O Papel das Ferrovias no Comércio Exterior", desc: "Guia completo sobre ferrovias brasileiras no comex: Norte-Sul, Carajás, Vitória-Minas, Transnordestina, FIOL, concessões e integração porto-ferrovia." },
  ...
  { slug: "contrato-cambio-tipos-prazos-obrigacoes", name: "Contrato de Câmbio no Comércio Exterior: Tipos, Prazos e Obrigações", desc: "Guia completo sobre contrato de câmbio no comex: tipos spot e forward, fechamento de câmbio, prazos, regulamentação BCB, contratação e hedge cambial." },
  ...
  { slug: "cte-mdfe-transporte-cargas-comex", name: "CT-e e MDF-e no Transporte de Cargas do Comércio Exterior", desc: "Guia sobre CT-e e MDF-e no transporte de cargas do comex: modelos, redespacho, integração portuária, Porto sem Papel, multimodal e rastreamento." },
  ...
  { slug: "controle-qualidade-importacao-procedimentos", name: "Controle de Qualidade na Importação: Procedimentos, Inspeções e Garantias", desc: "Guia sobre controle de qualidade na importação: inspeção pré-embarque, AQL, empresas inspetoras, ensaios laboratoriais, auditoria e garantias contratuais." },
  ...
  { slug: "despacho-aduaneiro-passo-a-passo-completo", name: "Despacho Aduaneiro na Importação: Passo a Passo Completo", desc: "Guia completo do despacho aduaneiro de importação no Brasil: parametrização canais verde/amarelo/vermelho/cinza, DUIMP, documentação, tributos, papel do despachante, prazos e dicas para evitar canais críticos." },
...
function main() {
  ...
  for (const bp of BLOG_POSTS) {
    ...
    const MAX_BLOG_TITLE = 84; // allows names up to 69 chars + " | Blog TRADEXA" (15) = 84
