...
const BLOG_POSTS = [
  ...
  { slug: "exportar-argentina-guia-completo", name: "Como Exportar para a Argentina: Guia Completo 2026", desc: "Guia completo para exportar para a Argentina em 2026: acordos ACE 14, produtos com maior potencial, documentação DU-E, logística, pagamentos, desafios regulatórios SIRA/SIRASE e oportunidades." },
  { slug: "exportar-chile-acordos-oportunidades", name: "Como Exportar para o Chile: Acordos e Oportunidades", desc: "Guia completo de exportação para o Chile: ACE 35, tarifas zero, produtos brasileiros com demanda, logística, requisitos sanitários, setores de vinho e salmão, e análise de mercado com inteligência comercial." },
