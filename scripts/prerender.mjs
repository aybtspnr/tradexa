...
{ slug: "balanca-comercial-brasileira-2026", name: "Balança Comercial 2026", desc: "Análise completa da balança comercial brasileira: exportações, importações, superávit, principais produtos e parceiros. Dados atualizados de exportacoes..." },
...
{ slug: "automatizacao-rpa-comex", name: "Automação de Processos no Comércio Exterior com RPA: Re", desc: "Guia sobre RPA no comércio exterior: automação de DUIMP, faturamento, câmbio, classificação NCM e integração com SISCOMEX. Dados oficiais do COMEXSTAT p..." },
...
{ slug: "barreiras-tecnicas-uniao-europeia-exportacao", name: "Introdução", desc: "A União Europeia (UE) é um dos mercados mais relevantes para as exportações brasileiras, figurando consistentemente entre os três principais destinos do..." },
{ slug: "barreiras-sanitarias-china-exportacao-alimentos", name: "Introdução", desc: "A República Popular da China consolidou-se, na última década, como o principal parceiro comercial do Brasil." },
