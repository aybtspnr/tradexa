...
const BLOG_POSTS = [
  ...
  { slug: "ex-tarifario-como-solicitar", name: "Ex-Tarifário: Como Solicitar", desc: "Saiba como solicitar o Ex-Tarifario para reduzir o Imposto de Importacao de maquinas e equipamentos sem similar nacional produzido no Brasil." },
  ...
  { slug: "esg-importadores-criterios-socioambientais", name: "ESG para Importadores: Critérios Socioambientais na Seleção de Fornecedores", desc: "Como incorporar critérios ESG na política de importação — due diligence socioambiental, avaliação de fornecedores, relat Guia completo com informacoes a..." },
  ...
  { slug: "duimp-na-pratica-como-se-preparar", name: "DUIMP na Prática: Como se Preparar para a Nova Declaração", desc: "Passo a passo prático para se preparar para a DUIMP: cadastro no catálogo de produtos, adequação de sistemas, treinament Do planejamento a execucao, com..." },
  ...
  { slug: "due-diligence-fornecedores-internacionais", name: "Due Diligence de Fornecedores Internacionais: Guia Completo", desc: "Metodologia completa de due diligence para fornecedores internacionais: verificação documental, reputacional, financeira Guia completo para encontrar e ..." },
  ...
  { slug: "ex-tarifario-reducao-passo-a-passo", name: "Ex-tarifário: Redução do Imposto de Importação Passo a Passo", desc: "Guia completo do Ex-tarifário: redução do II para BK e BIT, critérios de elegibilidade, processo CAMEX passo a passo, documentação, prazos, exemplos práticos com NCMs reais e renovação bienal." },
  ...
  { slug: "due-diligence-avaliacao-fornecedores", name: "Due Diligence Internacional: Como Avaliar Fornecedores", desc: "Guia completo de due diligence internacional: avaliação de fornecedores, listas de sanções OFAC/ONU, análise financeira, certificações, bandeiras vermelhas, bases de dados e compliance LGPD." },
