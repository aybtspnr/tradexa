...
const BLOG_POSTS = [
  ...
  { slug: "dta-documento-transito-aduaneiro", name: "DTA: Documento de Trânsito Aduaneiro", desc: "Entenda o DTA, quando é necessário, como emitir e as modalidades de trânsito aduaneiro. Guia completo do Documento de Trânsito Aduaneiro para operações de comex." },
  ...
  { slug: "digital-twins-logistica", name: "Gêmeos Digitais (Digital Twins) na Logística", desc: "Guia sobre gêmeos digitais na logística: simulação de armazéns, portos inteligentes, otimização de rotas, redução de custos e integração com IoT e big data." },
  ...
  { slug: "diversidade-inclusao-comercio-exterior-empresas", name: "Diversidade e Inclusão no Comércio Exterior Brasileiro", desc: "Guia completo sobre diversidade e inclusão no comércio exterior brasileiro: panorama, benefícios, programas de inclusão, métricas ESG e cases reais de empresas de comex." },
  ...
  { slug: "despacho-aduaneiro-passo-a-passo-completo", name: "Despacho Aduaneiro na Importação: Passo a Passo Completo", desc: "Guia completo do despacho aduaneiro de importação no Brasil: parametrização canais, DUIMP, documentação, tributos, prazos e dicas para evitar canais críticos." },
