...
{ slug: "automacao-comex-ferramentas-apis", name: "Automação no Comércio Exterior: Ferramentas e APIs", desc: "Como automatizar processos de comércio exterior com APIs — classificação fiscal, cotação de frete, consulta de dados e i Dados oficiais do COMEXSTAT par..." },
...
{ slug: "api-integracao-dados-comex", name: "APIs e Integração de Dados no Comex: Conectando Sistemas de Comércio Exterior", desc: "Guia sobre APIs no comex: integração com Siscomex, ERPs, plataformas de inteligência, automação e arquitetura de dados. Dados oficiais do COMEXSTAT para..." },
...
{ slug: "armazenagem-frigorificada-comex-controle-custos", name: "Armazenagem Frigorificada no Comércio Exterior: Controle, Custos e Reg", desc: "A armazenagem frigorificada é um dos elos mais críticos e estratégicos da cadeia logística internacional." },
...
{ slug: "servicos-engenharia-arquitetura-exportacao-internacional", name: "Exportação de Serviços de Engenharia e Arquitetura...", desc: "Guia completo sobre exportação de serviços de engenharia e arquitetura: projetos de infraestrutura, BIM, contratos FIDIC, tributação e oportunidades globais." },
  ...
  { slug: "associativismo-exportacao-resultados", name: "Associativismo na Exportação: Cases de Sucesso e Resultados para PM...", desc: "Guia completo sobre associativismo exportador: cases Wines of Brasil, Brazilian Gourmet Coffees, Brazilian Fashion, métricas de sucesso e ganhos de escala " },
  ...
  { slug: "arbitragem-internacional-contratos-comerciais", name: "Arbitragem Internacional em Contratos Comerciais: Guia para Exporta...", desc: "Guia completo sobre arbitragem internacional: câmaras arbitrais, cláusula compromissória, Convenção de Nova York e execução de sentenças arbitrais." },
