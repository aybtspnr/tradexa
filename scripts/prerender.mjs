...
{ slug: "certificacoes-sustentaveis-fair-trade-organico-rainforest", name: "Certificações Sustentáveis no Comércio Exterior: Fair Trade, Orgânico, Rainfores", desc: "Guia completo sobre as principais certificações sustentáveis exigidas no comércio internacional — como obter, quanto cus Guia completo com informacoes a..." },
...
{ slug: "cloud-computing-comex-solucoes-digitais", name: "Cloud Computing no Comex: Soluções Digitais para Importadores e Exportadores", desc: "Guia sobre cloud computing no comex: SaaS, IaaS, benefícios, desafios de adoção e tendências para digitalização do setor. Dados oficiais do COMEXSTAT pa..." },
...
{ slug: "servicos-engenharia-arquitetura-exportacao-internacional", name: "Exportação de Serviços de Engenharia e Arquitetura...", desc: "Guia completo sobre exportação de serviços de engenharia e arquitetura: projetos de infraestrutura, BIM, contratos FIDIC, tributação e oportunidades globais." },
  ...
  { slug: "comercio-exterior-amazonas", name: "Amazonas no Comércio Exterior: Zona Franca de Manaus e o Potencial da Região Norte", desc: "Análise completa do comércio exterior do Amazonas: Zona Franca de Manaus, Polo Industrial, SUFRAMA, incentivos fiscais, logística fluvial, Porto de Manaus, bioeconomia e oportunidades de exportação." },
  ...
  { slug: "comercio-exterior-alagoas", name: "Alagoas no Comércio Exterior: Química, Açúcar e o Complexo de Maceió", desc: "Análise do comércio exterior de Alagoas: complexo químico e petroquímico, açúcar e etanol, Porto de Maceió, mineração, gás natural e oportunidades de exportação." },
  ...
  { slug: "comercio-exterior-acre", name: "Acre no Comércio Exterior: Floresta, Produtos Sustentáveis e Integração com Peru e Bolívia", desc: "Análise do comércio exterior do Acre: produtos da sociobiodiversidade, ZPE, comércio fronteiriço com Peru e Bolívia, Estrada do Pacífico e bioeconomia." },
  ...
  { slug: "comercio-exterior-amapa", name: "Amapá no Comércio Exterior: Mineração, Recursos Naturais e o Corredor do Escudo Guianês", desc: "Análise do comércio exterior do Amapá: mineração de manganês e caulim, celulose, Porto de Santana, ZPE, comércio com Guiana Francesa e potencial do Arco Norte." },
