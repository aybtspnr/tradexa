...
const BLOG_POSTS = [
  ...
  { slug: "comex-stat-dados-comercio-exterior", name: "Dados de Comércio Exterior 2026: Guia Prático", desc: "Guia prático para acessar e interpretar dados de comércio exterior. Descubra tendências de mercado para tomada de decisão." },
  ...
  { slug: "como-calcular-custo-total-importacao", name: "Calcular o Custo Total de Importação: Fórmula", desc: "Aprenda a calcular o custo total com a fórmula: FOB + frete + seguro + II + IPI + PIS + COFINS + ICMS." },
  ...
  { slug: "simples-nacional-comercio-exterior-mei-me", name: "Simples Nacional no Comércio Exterior: Como Exportar e Importar como MEI ou ME", desc: "Guia completo sobre Simples Nacional no comércio exterior: regras para exportação e importação como MEI ou ME, limites de faturamento, tributação e obrigações acessórias." },
  { slug: "pis-cofins-regime-nao-cumulativo-comex", name: "PIS/PASEP e COFINS no Regime Não-Cumulativo: Créditos Básicos no Comex", desc: "Guia completo sobre PIS/PASEP e COFINS no regime não-cumulativo aplicado ao comércio exterior: créditos básicos na importação e exportação, exclusões e cálculo." },
  { slug: "drawback-suspensao-pratica-utilizar-sem-erros", name: "Drawback Suspensão na Prática: Como Utilizar o Regime sem Erros", desc: "Guia prático do regime de Drawback Suspensão: requisitos, procedimentos, obrigações acessórias, erros comuns e como a TRADEXA auxilia na gestão do regime." },
  { slug: "drawback-isencao-diferencas-suspensao-quando-utilizar", name: "Drawback Isenção: Diferenças do Drawback Suspensão e Quando Utilizar", desc: "Guia completo sobre Drawback Isenção: diferenças do Drawback Suspensão, quando utilizar cada modalidade, benefícios, procedimentos e combinação de regimes." },
  { slug: "recof-importacao-regime-especial-industrializacao", name: "RECOF na Importação: Regime Especial para Industrialização de Produtos Importados", desc: "Guia completo sobre o RECOF: regime especial para industrialização de produtos importados, benefícios fiscais, habilitação, processo operacional e diferenças do Drawback." },
  { slug: "admissao-temporaria-importacao-como-funciona", name: "Admissão Temporária na Importação: Como Importar sem Pagar Tributos Temporariamente", desc: "Guia completo sobre admissão temporária na importação: modalidades, finalidades permitidas, prazos, garantias, procedimentos e obrigações acessórias." },
  { slug: "exportacao-soja-brasileira-mercados-certificacoes-logistica", name: "Exportação de Soja Brasileira: Mercados, Certificações e Logística", desc: "Guia completo sobre a exportação de soja brasileira: principais mercados importadores, certificações, logística portuária, corredores de escoamento e inteligência de mercado." },
  { slug: "importacao-aco-siderurgicos-ncm-tributos-fornecedores", name: "Importação de Aço e Siderúrgicos: NCM, Tributos e Fornecedores", desc: "Guia completo para importação de aço e produtos siderúrgicos: classificação NCM, tributos, fornecedores globais, medidas antidumping e processo de desembaraço." },
  { slug: "exportacao-celulose-brasileira-mercados-logistica-tendencias", name: "Exportação de Celulose Brasileira: Mercados, Logística Portuária e Tendências", desc: "Guia sobre a exportação de celulose brasileira: principais mercados, logística portuária, sustentabilidade, certificações FSC/Cerflor e tendências do setor." },
  { slug: "importacao-vidros-ceramicas-regras-tributacao", name: "Importação de Vidros e Cerâmicas: Regras, Tributação e Cuidados no Transporte", desc: "Guia completo para importação de vidros e cerâmicas: classificação NCM, tributação, regras regulatórias, cuidados no transporte e documentação aduaneira." },
  { slug: "exportacao-carnes-suinas-mercados-certificacoes-sanitarias", name: "Exportação de Carnes Suínas: Mercados, Certificações Sanitárias e Logística", desc: "Guia completo sobre exportação de carnes suínas brasileiras: principais mercados, certificações sanitárias, logística da cadeia do frio e inteligência comercial." },
  { slug: "importacao-borracha-polimeros-ncm-aplicacoes-fornecedores", name: "Importação de Borracha e Polímeros: NCM, Aplicações Industriais e Fornecedores", desc: "Guia completo para importação de borracha e polímeros: classificação NCM, aplicações industriais, fornecedores globais, regulamentação e inteligência de mercado." },
  { slug: "armazenagem-frigorificada-comex-controle-custos", name: "Armazenagem Frigorificada no Comércio Exterior: Controle, Custos e Regulamentações", desc: "Guia completo sobre armazenagem frigorificada no comércio exterior: regulamentações, faixas de temperatura, custos operacionais, controle de qualidade e tecnologia." },
  { slug: "gestao-terminais-portuarios-operacao-portos-brasileiros", name: "Gestão de Terminais Portuários: Como Funciona a Operação nos Portos Brasileiros", desc: "Guia completo sobre gestão de terminais portuários no Brasil: operação, custos portuários, eficiência operacional, tecnologia e sustentabilidade portuária." },
  { slug: "transporte-aereo-carga-comex-custos-prazos-documentacao", name: "Transporte Aéreo de Carga no Comércio Exterior: Custos, Prazos e Documentação", desc: "Guia completo sobre transporte aéreo de carga no comércio exterior: custos, peso cubado, prazos, documentação AWB e infraestrutura aeroportuária brasileira." },
  { slug: "logistica-ultima-milha-comex-distribuicao-importados", name: "Logística de Última Milha no Comex: Distribuição de Produtos Importados", desc: "Guia completo sobre logística de última milha para produtos importados: modelos de distribuição, desafios, tecnologia de rastreamento e estratégias de otimização." },
  { slug: "seguro-credito-exportacao-protecao-inadimplencia-internacional", name: "Seguro de Crédito à Exportação: Como Proteger sua Empresa Contra Inadimplência Internacional", desc: "Guia sobre seguro de crédito à exportação: riscos cobertos, contratação, precificação, benefícios estratégicos, mercado segurador e processo de indenização." },
  { slug: "peso-cubado-frete-aereo-calcular-reduzir-custos", name: "Peso Cubado no Frete Aéreo: Como Calcular e Reduzir Custos de Transporte", desc: "Guia completo sobre peso cubado no frete aéreo: fórmula de cálculo, exemplos práticos, estratégias para reduzir custos com embalagem e otimização de carga." },
  { slug: "crm-comercio-exterior-gestao-relacionamento-internacional", name: "CRM para Comércio Exterior: Gestão de Relacionamento com Clientes Internacionais", desc: "Guia completo sobre CRM para comércio exterior: funcionalidades estratégicas, integração com inteligência de mercado, automação de processos e métricas de desempenho." },
  { slug: "vendas-b2b-internacionais-estrategias-canais-distribuicao", name: "Vendas B2B Internacionais: Estratégias e Canais de Distribuição para Exportadores", desc: "Guia sobre vendas B2B internacionais: estratégias de entrada, canais de distribuição, prospecção ativa, precificação e marketing digital para exportadores." },
  { slug: "precificacao-internacional-formar-preco-exportacao-competitivo", name: "Precificação Internacional: Como Formar Preço de Exportação Competitivo", desc: "Guia completo sobre precificação internacional: componentes de custo, modelos cost-plus e market-based, Incoterms, gestão de risco cambial e estratégias por mercado." },
  { slug: "distribuicao-internacional-canais-parceiros-contratos", name: "Distribuição Internacional: Canais, Parceiros e Contratos de Distribuição", desc: "Guia completo sobre distribuição internacional: canais diretos e indiretos, seleção de parceiros, contratos de distribuição, cláusulas essenciais e logística." },
  { slug: "plano-negocios-exportacao-estrutura-indicadores-metas", name: "Plano de Negócios para Exportação: Estrutura, Indicadores e Metas", desc: "Guia completo para elaborar um plano de negócios de exportação: estrutura, análise de mercado, projeções financeiras, KPIs, gestão de riscos e metas comerciais." },
  { slug: "planejamento-tributario-comex-economizar-legalmente", name: "Planejamento Tributário no Comex: Como Economizar Legalmente na Importação e Exportação", desc: "Guia completo sobre planejamento tributário no comércio exterior: classificação NCM estratégica, regimes aduaneiros especiais, créditos tributários e benefícios fiscais." },
  { slug: "bioeconomia-amazonia-oportunidades-exportacao-sustentavel", name: "Bioeconomia na Amazônia: Oportunidades de Exportação Sustentável para o Brasil", desc: "Guia sobre bioeconomia na Amazônia: produtos da sociobiodiversidade, certificações, logística, acordos comerciais e oportunidades de exportação sustentável." },
  { slug: "financas-verdes-comercio-exterior-green-bonds-creditos-carbono", name: "Finanças Verdes no Comércio Exterior: Green Bonds, Créditos de Carbono e Sustentabilidade", desc: "Guia completo sobre finanças verdes no comércio exterior: green bonds, mercado de carbono, linhas de crédito sustentável e impacto nas exportações brasileiras." },
  { slug: "exportar-para-jamaica-aluminio-turismo-oportunidades", name: "Exportar para a Jamaica: Oportunidades em Alumínio, Turismo e Produtos Alimentícios", desc: "Guia completo para exportar para a Jamaica: oportunidades nos setores de alumínio, turismo e hospitalidade, alimentos processados, logística portuária e acordos CARICOM." },
  { slug: "exportar-para-trinidad-tobago-petroleo-gas-oportunidades", name: "Exportar para Trinidad e Tobago: Petróleo, Gás e Oportunidades Comerciais", desc: "Guia para exportar para Trinidad e Tobago: hub energético do Caribe, oportunidades em petróleo e gás, alimentos, construção civil e logística portuária." },
  { slug: "exportar-para-barbados-turismo-alimentos-premium-luxo", name: "Exportar para Barbados: Turismo, Alimentos Premium e Produtos de Luxo", desc: "Guia completo para exportar para Barbados: oportunidades em turismo e hospitalidade, alimentos premium, produtos de luxo, logística e acordos comerciais no Caribe." },
  { slug: "servicos-despachante-aduaneiro-quando-contratar-como-escolher", name: "Serviços de Despachante Aduaneiro: Quando Contratar e Como Escolher o Profissional Certo para seu Comex", desc: "Guia completo sobre serviços de despachante aduaneiro: quando a contratação é obrigatória, como escolher o profissional ideal, serviços prestados e tendências da profissão." },
];
