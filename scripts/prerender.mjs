...
const BLOG_POSTS = [
  ...
  { slug: "exportar-para-argentina-oportunidades", name: "Introdução: A Relação Comercial Mais Importante do Brasil na América do Sul", desc: "A Argentina é, e continuará sendo, o principal parceiro comercial do Brasil na América do Sul. Guia completo com trâmites aduaneiros, documentacao e opo..." },
  ...
  { slug: "exportar-para-alemanha-guia", name: "Por Que Exportar para a Alemanha", desc: "A Alemanha é a maior economia da Europa, a quarta maior do mundo e o principal motor industrial do continente europeu. Tudo que voce precisa saber para ..." },
  ...
  { slug: "anvisa-importacao-alimentos-regularizacao", name: "Introdução: A Atuação da ANVISA na Importação de Alimentos", desc: "A importação de alimentos no Brasil é um segmento estratégico do comércio exterior, movimentando bilhões de dólares anualmente." },
  { slug: "api-integracao-dados-comex", name: "A Revolução Silenciosa das APIs no Comércio Exterior Brasileiro", desc: "O comércio exterior brasileiro sempre foi um ecossistema marcado por uma contradição fascinante: de um lado, empresas que operam globalmente, lidam com ..." },
  ...
  { slug: "associacoes-comerciais-comex-apoio", name: "O Papel Estratégico das Associações Comerciais no Comércio Exterior Br", desc: "As associações comerciais desempenham um papel fundamental no ecossistema do comércio exterior brasileiro, atuando como pontes entre empresas, governos ..." },
  { slug: "big-data-inteligencia-mercado-internacional", name: "Big Data na Inteligência de Mercado Internacional: O Novo Olho do Come", desc: "O comércio exterior brasileiro movimentou mais de US$ 340 bilhões em 2025. Por trás desse número colossal, há uma complexidade de informações que desafi..." },
  ...
  { slug: "bndes-financiamento-exportacao", name: "Introdução: O Papel Estratégico do BNDES no Financiamento às Exportaçõ", desc: "O Banco Nacional de Desenvolvimento Econômico e Social (BNDES) é, historicamente, o principal agente de fomento do comércio exterior brasileiro." },
  { slug: "camex-camara-comercio-exterior-funcoes", name: "Introdução: O que é a CAMEX e por que ela é Central no Comércio Exteri", desc: "A Câmara de Comércio Exterior — CAMEX — é o órgão máximo de deliberação e coordenação das políticas de comércio exterior no Brasil." },
  { slug: "ciberseguranca-comercio-exterior-protecao", name: "A Importância da Cibersegurança no Comércio Exterior Brasileiro", desc: "O comércio exterior brasileiro movimenta anualmente centenas de bilhões de dólares em mercadorias, serviços e ativos financeiros." },
  { slug: "cloud-computing-comex-solucoes-digitais", name: "O Papel Estratégico da Cloud Computing no Comércio Exterior", desc: "A transformação digital do comércio exterior brasileiro está em pleno curso, e a computação em nuvem (cloud computing) emerge como uma das tecnologias m..." },
  { slug: "contratos-frete-internacional-clausulas", name: "Introdução: A Importância dos Contratos de Frete Internacional no Comé", desc: "O comércio exterior brasileiro movimenta bilhões de dólares todos os anos, e o transporte internacional é a espinha dorsal que conecta exportadores e im..." },
  { slug: "cooperacao-tecnica-internacional-empresas", name: "O Que É Cooperação Técnica Internacional e Por Que Sua Empresa Deve Se", desc: "A cooperação técnica internacional é um mecanismo estratégico que permite a transferência de conhecimento, tecnologias e boas práticas entre países, org..." },
  ...
  { slug: "custos-logisticos-brasil-comparativo-exportacao", name: "Introdução", desc: "O Brasil ocupa uma posição singular no cenário logístico global. Como a nona maior economia do mundo e um dos maiores exportadores de commodities agríco..." },
  ...
  { slug: "exportar-para-bangladesh-vestuario-oportunidades", name: "Panorama do Setor Têxtil e de Vestuário em Bangladesh", desc: "Bangladesh consolidou-se como o segundo maior exportador de vestuário do mundo, perdendo apenas para a China." },
  ...
  { slug: "exportar-para-camboja-texteis-potencial", name: "Introdução: Por Que Exportar para o Camboja", desc: "O Camboja, oficialmente Reino do Camboja, é uma das economias que mais cresce no Sudeste Asiático e representa uma fronteira comercial promissora para o..." },
  ...
  { slug: "exportar-para-mianmar-agricultura-oportunidades", name: "Introdução", desc: "Mianmar — também conhecido como Birmânia — é um país do Sudeste Asiático com uma população de aproximadamente 55 milhões de habitantes, localizado entre..." },
  { slug: "exportar-para-mongolia-minerios-oportunidades", name: "Introdução", desc: "Quando se pensa em mercados promissores para a exportação brasileira, a Mongólia dificilmente é o primeiro país que vem à mente." },
  { slug: "exportar-para-nepal-artesanato-oportunidades", name: "O Potencial do Mercado Nepalês para Exportadores Brasileiros", desc: "O Nepal, país situado nos Himalaias entre a China e a Índia, é frequentemente subestimado no radar de exportadores brasileiros." },
  { slug: "exportar-para-paquistao-texteis-oportunidades", name: "O Setor Têxtil Paquistanês: Um Gigante Asiático em Expansão", desc: "O Paquistão é uma das maiores economias têxteis do mundo, ocupando a posição de oitavo maior exportador de produtos têxteis globalmente." },
  { slug: "exportar-para-sri-lanka-cha-borracha-gemas", name: "Introdução: Por Que Exportar para o Sri Lanka", desc: "O Sri Lanka, conhecido historicamente como Ceilão, é uma joia estratégica no Oceano Índico que oferece oportunidades únicas para o exportador brasileiro..." },
  ...
  { slug: "franquias-internacionais-exportacao-modelo-negocio", name: "O Novo Cenário das Franquias Brasileiras no Mundo", desc: "O setor de franquias brasileiro vive um momento histórico de expansão internacional." },
  ...
  { slug: "ia-generativa-comex-inovacao", name: "IA Generativa no Comércio Exterior: A Revolução Silenciosa que Está Tr", desc: "O comércio exterior brasileiro sempre foi um setor intensivo em documentação, processos burocráticos e conhecimento técnico especializado." },
  ...
  { slug: "importar-da-turquia-texteis-maquinario", name: "Por que Importar da Turquia?", desc: "A Turquia consolidou-se como um dos polos industriais mais estratégicos do mundo, conectando Europa, Ásia e Oriente Médio." },
  { slug: "inventarios-importacao-gestao-estoques", name: "Introdução: A Importância da Gestão de Estoques na Importação", desc: "A gestão de estoques é um dos pilares mais críticos para o sucesso de qualquer operação de comércio exterior." },
  { slug: "licenciamento-marcas-internacional", name: "A Importância Estratégica do Licenciamento de Marcas no Comércio Globa", desc: "No cenário empresarial contemporâneo, a marca deixou de ser apenas um elemento de identificação visual para se tornar um dos ativos mais valiosos de uma..." },
  ...
  { slug: "mdic-ministerio-desenvolvimento-comex", name: "Introdução: O MDIC e sua Relevância no Comércio Exterior Brasileiro", desc: "O Ministério do Desenvolvimento, Indústria, Comércio e Serviços — MDIC — é um dos ministérios mais importantes para o setor produtivo brasileiro e, em p..." },
  { slug: "otimizacao-rotas-transporte-maritimo", name: "Introdução: O Transporte Marítimo como Pilar do Comércio Exterior Bras", desc: "O transporte marítimo é responsável por aproximadamente 90% de todo o comércio mundial em volume de carga." },
  ...
  { slug: "rastreamento-carga-real-time-internacional", name: "Introdução: A Nova Era do Rastreamento de Carga no Comércio Exterior", desc: "O comércio exterior brasileiro movimenta bilhões de dólares anualmente, com milhares de contêineres atravessando oceanos, cruzando fronteiras e percorre..." },
  ...
  { slug: "seguros-internacionais-carga-transporte", name: "Introdução", desc: "O comércio exterior brasileiro movimenta bilhões de dólares anualmente, com milhares de contêineres cruzando fronteiras por via marítima, aérea, rodoviá..." },
  ...
  { slug: "software-gestao-comex-erp-internacional", name: "O Cenário dos ERPs no Comércio Exterior Brasileiro", desc: "A gestão eficiente do comércio exterior brasileiro exige sistemas de informação robustos e integrados." },
  ...
  { slug: "transporte-multimodal-comex-vantagens", name: "Introdução: A Revolução Logística no Comércio Exterior Brasileiro", desc: "O comércio exterior brasileiro enfrenta desafios logísticos imensos. Com dimensões continentais, infraestrutura de transportes heterogênea e uma pauta e..." },
  { slug: "transportes-intermodal-brasil-vantagens", name: "Introdução: A Importância do Transporte Intermodal no Brasil", desc: "O Brasil é um país de dimensões continentais, com uma matriz de transportes historicamente concentrada no modal rodoviário e uma infraestrutura logístic..." },
