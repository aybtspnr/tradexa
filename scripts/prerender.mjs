...
const BLOG_POSTS = [
  ...
  { slug: "exportacao-madeira-tropical-sustentabilidade", name: "Exportação de Madeira Tropical: Sustentabilidade e Mercados", desc: "Guia para exportação de madeira tropical brasileira: manejo sustentável certificado, DOF/Sinaflor, FSC, EUDR, IBS, concorrentes globais, logística na Amazônia e conformidade regulatória internacional." },
  ...
  { slug: "exportacao-cacau-chocolate-premium", name: "Exportação de Cacau e Chocolate Artesanal: Mercados Premium", desc: "Guia completo para exportar cacau fino e chocolate artesanal brasileiro: variedades Parazinho e Catongo, bean-to-bar, certificações, mercados premium, BIOFACH, Salon du Chocolat e NCM 1801-1806." },
