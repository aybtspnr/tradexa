...
{ slug: "agente-de-carga-o-que-e", name: "Agente de Carga: O Que É", desc: "Entenda a diferença entre agente de carga e despachante aduaneiro e como escolher o profissional certo. Coberturas disponiveis, procedimentos em caso de..." },
...
{ slug: "acordo-mercosul-ue-impactos", name: "Acordo Mercosul-UE: Impactos", desc: "Acordo Mercosul-UE: setores beneficiados, alíquotas reduzidas e impactos para exportadores. Dados, vantagens fiscais e infraestrutura logistica para ope..." },
...
{ slug: "admissao-temporaria-importacao-como-funciona", name: "O que é a Admissão Temporária na Importação?", desc: "A admissão temporária é um regime aduaneiro especial que permite a importação de mercadorias estrangeiras no Brasil com suspensão total ou parcial do pa..." },
