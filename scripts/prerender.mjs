...
{ slug: "servicos-engenharia-arquitetura-exportacao-internacional", name: "Exportação de Serviços de Engenharia e Arquitetura...", desc: "Guia completo sobre exportação de serviços de engenharia e arquitetura: projetos de infraestrutura, BIM, contratos FIDIC, tributação e oportunidades globais." },
  ...
  { slug: "comercio-exterior-mato-grosso-sul", name: "Mato Grosso do Sul no Comércio Exterior: Agronegócio, Biocombustíveis e Fronteira", desc: "Análise do comércio exterior de Mato Grosso do Sul: produção de grãos, celulose, etanol de milho, Rota Bioceânica, hidrovia Paraguai-Paraná e comércio fronteiriço." },
