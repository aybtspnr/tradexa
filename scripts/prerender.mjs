...
{ slug: "exportar-para-argentina-oportunidades", name: "Argentina: A Relação Comercial Mais Importante do Brasil na América do Sul", desc: "A Argentina é, e continuará sendo, o principal parceiro comercial do Brasil na América do Sul. Guia completo com trâmites aduaneiros, documentacao e opo..." },
...
{ slug: "exportar-cachaca-mercados-certificacoes", name: "Introdução", desc: "A cachaça é um dos produtos mais emblemáticos do Brasil. Reconhecida mundialmente como a aguardente brasileira típica, a cachaça carrega consigo séculos..." },
{ slug: "exportar-frutas-brasileiras-mercados-logistica", name: "Introdução", desc: "O Brasil é um dos maiores produtores de frutas do mundo, ocupando consistentemente a terceira posição no ranking global, atrás apenas da China e da Índi..." },
...
{ slug: "exportar-castanhas-brasil-nuts-mercados", name: "Introdução", desc: "O Brasil é um dos maiores players mundiais no mercado de castanhas e nuts, com uma produção diversificada que inclui castanha-do-Brasil (castanha-do-Par..." },
